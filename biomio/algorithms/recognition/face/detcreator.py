from biomio.algorithms.cascades.classifiers import CascadeClassifierSettings, CascadeROIDetector
from biomio.algorithms.recognition.keypoints import KeypointsObjectDetector
from biomio.algorithms.recognition.face.fmd_keypoints import FeaturesMatchingDetector
from biomio.algorithms.recognition.face.spiral_keypoints import SpiralKeypointsVectorDetector
from biomio.algorithms.recognition.face.objects_keypoints import ObjectsMatchingDetector
from biomio.algorithms.recognition.face.clusters_db_keypoints import ClustersDBMatchingDetector
from biomio.algorithms.recognition.face.clusters_templateL0_keypoints import ClustersTemplateL0MatchingDetector
from biomio.algorithms.recognition.face.clusters_templateL1_keypoints import ClustersTemplateL1MatchingDetector
